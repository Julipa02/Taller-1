...
public class ConsolaOlimpicos
{
	...
	private void ejecutaratletaporpais()
	{
		String atleta = input("Por favor ingrese el nombre del atleta");
		String pais = calculadora.atletaporpais(atleta);
		if (pais == null)
		{
		...
		{
			System.out.println("El atleta que esta buscando es del siguiente pais: "+pais);
		}
	}
